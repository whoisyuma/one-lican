...
- 利用額合計金額の表示：精算方法だけでなく、個別の利用額の表示も行います。
- 利用額詳細情報の表示：個別の利用額のうち、何に何円使用したのかの詳細も表示します。
...
- ~~利用額合計金額の表示：割り勘の精算機能だけでなく、個別の利用額の表示も行う。~~　（実装済み）
- ~~利用額詳細情報の表示：個別の利用額のうち、何に何円使用したのかの詳細も表示する。~~　（実装済み）
