      ...
      <div className="lg:w-1/2 md:w-2/3 w-full m-auto px-5 md:px-0 pt-10">
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="md:text-lg text-sm text-center">
            グループページのURLをコピーして、メンバーに共有しましょう。
          </p>
        </div>

        <div className="mb-10 flex justify-start border-2 rounded-xl px-3 py-1 md:py-2 overflow-x-auto">
          <h1 className="md:text-xl text-base whitespace-nowrap">
            https://one-lican.vercel.app/group/{group?.id}/home
          </h1>
        </div>

        <div className="flex justify-center">
          <GoHomeButton
            href={`/group/${group?.id}/home`}
            className="bg-sky-600 text-center text-white rounded-3xl md:text-xl text-base md:py-3 py-2 w-2/3"
          >
            グループページへ進む
          </GoHomeButton>
        </div>
